...
public class FrmResultados extends javax.swing.JFrame {
     ...
     * @param partida
     */
    public FrmResultados(Partida partida) {
        initComponents();
        ...
        for (int i = 0; i < this.partida.getMarcador().getJugadores().size(); i++) {
                ...
                formato = formato + "\n           " + (i+1) + "                                          " 
                    + this.partida.getMarcador().getJugadores().get(i).getNombre() +" - " + this.partida.getMarcador().getJugadores().get(i).getPuntaje()+ "\n";
    ...
    private void initComponents() {
        ...
        txtResultados.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
