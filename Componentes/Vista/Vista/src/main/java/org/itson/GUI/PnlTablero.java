...
import org.itson.Dominio.Punto;
...
import org.itson.Interfaces.PnlObservable;
import org.itson.Interfaces.PnlObservador;
import org.itson.Utils.FormaPolygon;
import org.itson.Utils.UtilesTablero;
...
public class PnlTablero extends javax.swing.JPanel implements PnlObservable, MouseListener, MouseMotionListener {
    ...
    public void mouseClicked(MouseEvent me) {
        ...
        if (lineaEncontrada != null) {
            if (lineaEncontrada.getJugador() != null) {
                ...
                List<CasillaJugador> movimiento = new ArrayList<>();
    ...
    public void actualizaCuadroTablero(Cuadro cuadro) {
        ...
        Jugador jugador1 = cuadro.getJugador();
        int puntaje = jugador1.getPuntaje()+1;
        jugador1.setPuntaje(puntaje);
    ...
    @Override
    public void notificaMovimiento(List<CasillaJugador> movimiento) {
